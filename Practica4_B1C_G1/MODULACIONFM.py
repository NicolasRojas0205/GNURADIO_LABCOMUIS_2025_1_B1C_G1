...
class MODULACIONFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 625E4
        self.fcb = fcb = 100e3
        self.fc = fc = 907e5
        self.GRX = GRX = 0
        self.D = D = 25
        ...
        self._fcb_win = qtgui.RangeWidget(self._fcb_range, self.set_fcb, "Frecuencia de corte filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcb_win)
        self._fc_range = qtgui.Range(88e6, 108e6, 1e5, 907e5, 200)
