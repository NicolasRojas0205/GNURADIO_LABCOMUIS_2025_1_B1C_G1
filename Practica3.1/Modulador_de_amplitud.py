...
import time
from modulacionAMRP import modulacionAMRP  # grc-generated hier_block
import sip
import threading
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(300, samp_rate/4, 100, 1000, 200)
        ...
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuenca portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "Amplitudportadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.modulacionAMRP_0 = modulacionAMRP(
            Ac=Ac,
            ka=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.modulacionAMRP_0, 0))
        self.connect((self.modulacionAMRP_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.modulacionAMRP_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.modulacionAMRP_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.modulacionAMRP_0.set_ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.modulacionAMRP_0.set_Ac(self.Ac)
