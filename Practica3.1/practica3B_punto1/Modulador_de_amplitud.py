...
from Modulador_AM import Modulador_AM  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Modulador_AM_0 = Modulador_AM(
            Ac=Ac,
            ka=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_AM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Modulador_AM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.Modulador_AM_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Modulador_AM_0.set_ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_AM_0.set_Ac(self.Ac)
