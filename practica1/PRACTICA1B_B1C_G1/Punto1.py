...
class Punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Punto1")
        ...
        self._fc_range = qtgui.Range(50000000, 2200000000, 1000000, 50000000, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuencia portadora", "slider", float, QtCore.Qt.Vertical)
        ...
        self._A_range = qtgui.Range(0, 1, 0.001, 0.5, 200)
