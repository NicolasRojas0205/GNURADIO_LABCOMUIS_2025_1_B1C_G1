...
class punto_4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "punto_4")
        ...
        self.frequency = frequency = 4500

        ##################################################
        # Blocks
        ##################################################

        self._frequency_range = qtgui.Range(-16000, 16000, 100, 4500, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frequency, 3, 0, 0)
...
def main(top_block_cls=punto_4, options=None):
